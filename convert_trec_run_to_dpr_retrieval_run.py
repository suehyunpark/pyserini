...
if __name__ == "__main__":
    ...
    with open('/home/miyoung/suehyun/DPR/input/retriever/reddit/reddit-val-v3-sampled.json', 'r', encoding='utf-8') as f:
        queries = json.load(f)
